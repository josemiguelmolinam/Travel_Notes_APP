...
const HomePage = () => {
  ...
  return (
    <div className='home-page'>
      ...
      <h2>
        ¡Descubre los lugares más increíbles para viajar y guardar tus notas de
        ...
        {!token && (
          <>
            ...
            <div className='button-register'>
              <NavLink className='clickable-button' to='/register'>
                Registro
              </NavLink>
            </div>
          </>
        ...
        {token && (
          <>
            ...
            <div className='button-logout'>
              <NavLink className='clickable-button' onClick={handleLogout}>
                Cerrar Sesión
              </NavLink>
            </div>
          </>
